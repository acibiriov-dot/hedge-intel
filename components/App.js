    ...
    <div style={{ minHeight: "100vh", background: "#f5f5f0", fontFamily: "system-ui, -apple-system, sans-serif", color: "#1a1a1a" }}>
      ...
      <div style={{ background: "#1a1a2e", padding: "0 24px", display: "flex", alignItems: "center", justifyContent: "space-between", height: 56, position: "sticky", top: 0, zIndex: 100 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          <a href="/dashboard" style={{ background: "transparent", border: "1px solid #4caf50", color: "#4caf50", padding: "6px 12px", borderRadius: 6, fontSize: 12, fontWeight: 700, textDecoration: "none", letterSpacing: 0.3 }}>🎛 Дашборд</a>
          <a href="/volatility" style={{ background: "transparent", border: "1px solid #10b981", color: "#10b981", padding: "6px 12px", borderRadius: 6, fontSize: 12, fontWeight: 700, textDecoration: "none", letterSpacing: 0.5, fontFamily: "ui-monospace, monospace" }}>σ Опционный Архитектор</a>
          <a href="/briefing" style={{ background: "transparent", border: "1px solid #10b981", color: "#10b981", padding: "6px 12px", borderRadius: 6, fontSize: 12, fontWeight: 700, textDecoration: "none", letterSpacing: 0.5, fontFamily: "ui-monospace, monospace" }}>☼ БРИФИНГ</a>
          <a href="/strategies" style={{ background: "transparent", border: "1px solid #10b981", color: "#10b981", padding: "6px 12px", borderRadius: 6, fontSize: 12, fontWeight: 700, textDecoration: "none", letterSpacing: 0.5, fontFamily: "ui-monospace, monospace" }}>◇ Рекомендуемая Сделка</a>
          <a href="/covered-call" style={{ background: "transparent", border: "1px solid #10b981", color: "#10b981", padding: "6px 12px", borderRadius: 6, fontSize: 12, fontWeight: 700, textDecoration: "none", letterSpacing: 0.5, fontFamily: "ui-monospace, monospace" }}>◆ ДВИЖОК РЕШЕНИЙ</a>
          <a href="/smart-strategy" style={{ background: "transparent", border: "1px solid #d97706", color: "#ffd700", padding: "6px 12px", borderRadius: 6, fontSize: 12, fontWeight: 700, textDecoration: "none", letterSpacing: 0.3 }}>⚡ Умная стратегия</a>
